---
name: plan-gate
description: Calibrated grilling session for stress-testing a plan, design, idea, or decision (vendored from JuliusBrussee/skills "grill-me", MIT). First assesses the user's topic knowledge, confidence, and desired pressure level, then asks one question at a time with recommended answers. Use when user says "grill me", "plan-gate", "stress-test this", "challenge my plan", "interview me", or wants a plan probed before implementation.
---
